import { Home, User, Calendar, MapPin, MessageCircle, Bell, Settings, HelpCircle, Star, Briefcase, DollarSign, Heart, Search, ClipboardList, Menu, X, Plus, Package, FileText, Zap } from "lucide-react";
...
const clientItems = [
  ...
  { title: "My Job Listings", url: "/job-listings", icon: FileText },
...
const providerItems = [
  ...
  { title: "Available Jobs", url: "/available-jobs", icon: Zap },
